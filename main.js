...
document.querySelector('.bxs-moon').onclick=function(){
  ...
  document.querySelector('.test').classList.add('dark');
...
document.querySelector('.bxs-sun').onclick=function(){
  document.querySelector('.discount-left').classList.remove('dark');
  ...
  document.querySelector('.test').classList.remove('dark');
